...
class LayoutManager(textures: MyTextures) {
	...
	val layout = arrayOf<Array<LayoutTile?>>(
		arrayOf(null,		BAG,		null,		APPLE,		null,		null),
		arrayOf(null,		null,		null,		null,		STONE,		null),
		arrayOf(null,		STONE,		null,		null,		null,		BAG),
		arrayOf(null,		null,		null,		null,		STONE,		null),
		...
		arrayOf(null,		null,		null,		null,		null,		APPLE),
		arrayOf(STONE,		DYNAMITE,	null,		STONE,		STONE,		null),
		arrayOf(null,		null,		null,		STONE,		STONE,		null),
		arrayOf(STONE,		BOOT,		null,		null,		APPLE,		null),
		arrayOf(STONE,		STONE,		null,		STN_BLK,	STN_BLK,	null),
		arrayOf(STONE,		DIAMOND,	null,		STN_BLK,	STN_BLK,	null),
		arrayOf(null,		APPLE,		null,		ROOT,		DYNAMITE,	null),
